    ...
    <div class="orders">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="box-title">List Transaksi</h4>
                    </div>
                    <div class="card-body--">
                        <div class="table-stats order-table ov-h">
                            <table class="table">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{route('transactions.destroy', $item->id)}}" class="d-inline" method="post">
                                                    @csrf
                                                    @method('delete')
                                                    <button class="btn btn-danger btn-sm" onclick="return confirm('Hapus data transaksi {{$item->name}}')">
                                    ...
                                    @empty
                                        <tr>
                                            <td class="text-center p-4" colspan="7">Data Kosong</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
